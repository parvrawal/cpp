...
class Tea
{
    // protected allowed access in inheritence
    ...
    public: 
        MasalaTea(int serve) : Tea("Masala Tea", serve){
            cout << "Masala Tea constructor called" << endl;
                ...
                // final kryword means from here no one can modify it
        void brew() const override  final {
            cout << "Brewing" << " with spices and milk" << endl;
        }
...
//     public:
//         void brew() const override{
//             cout << "Brwing" << teaName << " with spices and milk" << endl;
//         }
